...
export default function OnboardingScreen3({ onNext }: OnboardingScreen3Props) {
    const htmlContent = `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
            <lord-icon
                ...
                trigger="loop"
                delay="2000"
                state="hover-interface"
                colors="primary:#ffffff,secondary:#ae7aff,tertiary:#000000,quaternary:#000000,quinary:#ffc738"
