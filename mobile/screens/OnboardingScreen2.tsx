...
export default function OnboardingScreen2({ onNext }: OnboardingScreen2Props) {
    const htmlContent = `
        ...
        <body>
            <lord-icon
                id="mainIcon"
                src="https://cdn.lordicon.com/opdurtxk.json"
                trigger="loop"
                delay="2000"
                colors="primary:#ffffff,secondary:#ae7aff,tertiary:#000000"
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                <Text style={styles.heading}>Your emails</Text>
                <Text style={styles.heading}>become actions.</Text>
            </View>
