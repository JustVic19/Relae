...
export default function OnboardingScreen1({ onNext }: OnboardingScreen1Props) {
    const htmlContent = `
        ...
        <body>
            <lord-icon
                id="mainIcon"
                src="https://cdn.lordicon.com/kfjxtwnh.json"
                trigger="loop"
                delay="3500"
                state="in-reveal"
                colors="primary:#ffffff,secondary:#000000,tertiary:#ebe6ef,quaternary:#ae7aff"
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                <Text style={styles.heading}>Your student life.</Text>
                <Text style={styles.heading}>In one place.</Text>
            </View>
